...
export default async function handler(req, res) {
  ...
  try {
    // Construire les paramètres — customer_email seulement si valide
    const params = {
    ...
    // N'ajouter customer_email que si l'adresse est valide (Stripe rejette les chaînes vides)
    ...
    console.log(`Lien Stripe créé pour ${clientName} — ${amount}€ — session: ${session.id}`);
